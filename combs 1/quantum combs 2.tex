...
The author acknowledges the use of computational and language tools for drafting assistance. No funding was received for this work. No competing interests are declared.

\section*{Data Availability}
No data were generated or analyzed in this study.

\section*{Supplementary Material}
Independent numerical corroboration of the statements of this article,
consisting of an annotated script, a README mapping each check to the
statement it corroborates, and the output log of a complete run, is
available at \url{https://github.com/MIKEAA2020/Quantum-combs/tree/main/combs%201}.
All proofs in this article are analytic and self-contained; the
supplementary computations are corroborative and do not enter any proof.
